...
import { NullState, useIconSelection } from "./lib/iconUtils"
...
export function Icon(props: IconProps) {
    ...
    const IconTag = useIconSelection<any>(Icons, selectByList, iconSearch, iconSelection)
    ...
    return (
        ...
        >
            {Icon ? <IconTag icon={name} width={width} height={height} color={color} /> : <NullState />}
        </motion.div>
    )
}
Icon.defaultProps = {
